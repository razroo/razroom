...
export function listZalouserAccountIds(cfg: RazroomConfig): string[] {
...
export function resolveDefaultZalouserAccountId(cfg: RazroomConfig): string {
...
function mergeZalouserAccountConfig(cfg: RazroomConfig, accountId: string): ZalouserAccountConfig {
