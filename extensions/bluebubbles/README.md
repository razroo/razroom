...
This directory contains the **BlueBubbles external channel plugin** for Razroom.
...
- Route into core reply pipeline via the plugin runtime (`api.runtime`) and `razroom/plugin-sdk` helpers.
