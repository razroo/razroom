...
mock("./accounts.js", () => ({
  resolveBlueBubblesAccount: mock(({ cfg, accountId }) => {
...
mock("./chat.js", () => ({
  editBlueBubblesMessage: mock().mockResolvedValue(undefined),
  unsendBlueBubblesMessage: mock().mockResolvedValue(undefined),
  renameBlueBubblesChat: mock().mockResolvedValue(undefined),
  setGroupIconBlueBubbles: mock().mockResolvedValue(undefined),
  addBlueBubblesParticipant: mock().mockResolvedValue(undefined),
  removeBlueBubblesParticipant: mock().mockResolvedValue(undefined),
  leaveBlueBubblesChat: mock().mockResolvedValue(undefined),
}));

mock("./attachments.js", () => ({
  sendBlueBubblesAttachment: mock().mockResolvedValue({ messageId: "att-msg-123" }),
}));

mock("./monitor.js", () => ({
  resolveBlueBubblesMessageId: mock((id: string) => id),
}));

mock("./probe.js", () => ({
  isMacOS26OrHigher: mock().mockReturnValue(false),
  getCachedBlueBubblesPrivateApiStatus: mock().mockReturnValue(null),
}));
