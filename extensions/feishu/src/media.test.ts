...
const normalizeFeishuTargetMock = vi.hoisted(() => mock());
const resolveReceiveIdTypeMock = vi.hoisted(() => mock());
const loadWebMediaMock = vi.hoisted(() => mock());

const fileCreateMock = vi.hoisted(() => mock());
const messageCreateMock = vi.hoisted(() => mock());
const messageReplyMock = vi.hoisted(() => mock());
