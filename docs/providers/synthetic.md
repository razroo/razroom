---
summary: "Use Synthetic's Anthropic-compatible API in Razroom"
read_when:
...
Synthetic exposes Anthropic-compatible endpoints. Razroom registers it as the
...
Note: Razroom's Anthropic client appends `/v1` to the base URL, so use
