...
You can point Razroom at the proxy as a custom OpenAI-compatible endpoint:
...
- This is a **community tool**, not officially supported by Anthropic or Razroom
...
- [Anthropic provider](/providers/anthropic) - Native Razroom integration with Claude setup-token or API keys
