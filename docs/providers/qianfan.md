---
summary: "Use Qianfan's unified API to access many models in MoltBot"
read_when:
...
3. MoltBot installed on your system
...
4. Copy the API key for use with MoltBot

## CLI setup

```bash
moltbot onboard --auth-choice qianfan-api-key
```

## Related Documentation

- [MoltBot Configuration](/gateway/configuration)
