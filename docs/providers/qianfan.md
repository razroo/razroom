---
summary: "Use Qianfan's unified API to access many models in Razroom"
read_when:
...
3. Razroom installed on your system
...
4. Copy the API key for use with Razroom

## CLI setup

```bash
razroom onboard --auth-choice qianfan-api-key
```

## Related Documentation

- [Razroom Configuration](/gateway/configuration)
