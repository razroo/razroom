---
summary: "First-run onboarding flow for Razroom (macOS app)"
read_when:
...
<Frame caption="Choose what permissions do you want to give Razroom">
...
<Step title="CLI">
  ...
  The app can install the global `razroom` CLI via npm/pnpm so terminal
