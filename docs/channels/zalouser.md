...
read_when:
  - Setting up Zalo Personal for Razroom
...
- Install via CLI: `razroom plugins install @razroom/zalouser`
- Or from a source checkout: `razroom plugins install ./extensions/zalouser`
...
- `razroom pairing list zalouser`
- `razroom pairing approve zalouser <code>`
...
- On startup, Razroom resolves group/user names in allowlists to IDs and logs the mapping; unresolved entries are kept as typed.
...
- Re-login: `razroom channels logout --channel zalouser && razroom channels login --channel zalouser`
