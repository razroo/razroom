...
```bash
razroom plugins install ./extensions/nextcloud-talk
```
...
2. On your Nextcloud server, create a bot:
   ...
   ```bash
   ./occ talk:bot:install "Razroom" "<shared-secret>" "<webhook-url>" --feature reaction
   ```
...
- Approve via:
  - `razroom pairing list nextcloud-talk`
  - `razroom pairing approve nextcloud-talk <CODE>`
