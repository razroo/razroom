...
- Same path: run the app from a fixed location (for Razroom, `dist/Razroom.app`).
...
Workaround: move files into the Razroom workspace (`~/.razroom/workspace`) if you want to avoid per-folder grants.
