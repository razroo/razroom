...
Razroom treats **wake words as a single global list** owned by the **Gateway**.
...
- `~/.razroom/settings/voicewake.json`

Shape:

```json
{ "triggers": ["razroom", "claude", "computer"], "updatedAtMs": 1730000000000 }
```
