...
将 MoltBot 部署到生产服务器的推荐方式是通过 **[moltbot-ansible](https://github.com/moltbot/moltbot-ansible)** — 一个安全优先架构的自动化安装程序。
...
>
> moltbot-ansible 仓库是 Ansible 部署的权威来源。本页是快速概述。
...
Ansible 安装程序设置 MoltBot 为手动更新。标准更新流程参见[更新](/install/updating)。
