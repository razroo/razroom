...
MoltBot 被设计为易于扩展。"Skills"是为你的助手添加新功能的主要方式。
...
Skills 位于你的工作区中，通常是 `~/.moltbot/workspace/skills/`。为你的 Skill 创建一个新文件夹：

```bash
mkdir -p ~/.moltbot/workspace/skills/hello-world
```
...
让你的智能体"刷新 skills"或重启 Gateway 网关。MoltBot 将发现新目录并索引 `SKILL.md`。
