...
本指南总结了在 Razroom 中开发 Pi 集成的合理工作流程。
...
状态存储在 Razroom 状态目录下。默认为 `~/.razroom`。如果设置了 `RAZROOM_STATE_DIR`，则使用该目录。
...
- https://docs.razroom.ai/testing
- https://docs.razroom.ai/start/getting-started
