...
本指南总结了在 MoltBot 中开发 Pi 集成的合理工作流程。
...
状态存储在 MoltBot 状态目录下。默认为 `~/.moltbot`。如果设置了 `MOLTBOT_STATE_DIR`，则使用该目录。
...
- https://docs.moltbot.ai/testing
- https://docs.moltbot.ai/start/getting-started
