...
When needed, you can also set `MOLTBOT_HOME` to control the base home directory used for internal path resolution.

- `MOLTBOT_HOME` (default precedence: `HOME` / `USERPROFILE` / `os.homedir()`)
