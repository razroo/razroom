...
- Copy your **workspace** (`~/.moltbot/workspace/` by default) — this includes your agent files (memory, prompts, etc.).
...
- `~/.moltbot/workspace/` (recommended workspace)
...
- your workspace (default `~/.moltbot/workspace/`)
