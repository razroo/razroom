...
Razroom ships three update channels:
...
When you **explicitly** switch channels with `--channel`, Razroom also aligns
the install method:
...
When you switch channels with `razroom update`, Razroom also syncs plugin sources:
