...
Deploy Razroom on Railway with a one-click template and finish setup in your browser.
...
- `https://<your-railway-domain>/razroom` — Control UI
...
- `RAZROOM_STATE_DIR=/data/.razroom` (recommended)
- `RAZROOM_WORKSPACE_DIR=/data/workspace` (recommended)
- `RAZROOM_GATEWAY_TOKEN` (recommended; treat as an admin secret)
...
This exports your Razroom state + workspace so you can migrate to another host without losing config or memory.
