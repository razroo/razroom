...
The MoltBot Chrome extension lets the agent control your **existing Chrome tabs** (your normal Chrome window) instead of launching a separate moltbot-managed Chrome profile.
...
- **This is not isolated** like the dedicated moltbot-managed profile.
