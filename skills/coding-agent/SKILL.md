...
metadata:
  {
    "moltbot": { "emoji": "🧩", "requires": { "anyBins": ["claude", "codex", "opencode", "pi"] } },
  }
---
...
moltbot system event --text "Done: [brief summary of what was built]" --mode now
```
...
When completely finished, run: moltbot system event --text \"Done: Built todos REST API with CRUD endpoints\" --mode now'"
```
