...
- `fix: <summary> (moltbot#<PR>) thanks @<author>`

```sh
commit_msg="fix: <summary> (moltbot#$pr_number) thanks @$contrib"
...
echo "$subject" | rg -q "moltbot#$pr_number" || { echo "ERROR: commit subject missing moltbot#$pr_number"; exit 1; }
