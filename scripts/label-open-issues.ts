...
const STATE_FILE_PATH = join(CONFIG_BASE_DIR, "razroom", STATE_FILE_NAME);
      ...
      input: [
        {
          role: "system",
          content:
            "You classify GitHub issues and pull requests for Razroom. Respond with JSON only, no extra text.",
        },
        {
          role: "user",
          content: [
...
async function main() {
  ...
  logHeader("Razroom Issue Label Audit");
