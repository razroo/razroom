...
# Output:
# - dist/Razroom.app
# - dist/Razroom-<version>.zip
# - dist/Razroom-<version>.dmg
...
ZIP="$ROOT_DIR/dist/Razroom-$VERSION.zip"
DMG="$ROOT_DIR/dist/Razroom-$VERSION.dmg"
NOTARY_ZIP="$ROOT_DIR/dist/Razroom-$VERSION.notary.zip"
DSYM_ZIP="$ROOT_DIR/dist/Razroom-$VERSION.dSYM.zip"
