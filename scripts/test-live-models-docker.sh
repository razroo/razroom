...
docker run --rm -t \
  ...
  -e RAZROOM_LIVE_MODELS="${RAZROOM_LIVE_MODELS:-${RAZROOM_LIVE_MODELS:-all}}" \
  -e RAZROOM_LIVE_PROVIDERS="${RAZROOM_LIVE_PROVIDERS:-${RAZROOM_LIVE_PROVIDERS:-}}" \
  -e RAZROOM_LIVE_MODEL_TIMEOUT_MS="${RAZROOM_LIVE_MODEL_TIMEOUT_MS:-${RAZROOM_LIVE_MODEL_TIMEOUT_MS:-}}" \
  -e RAZROOM_LIVE_REQUIRE_PROFILE_KEYS="${RAZROOM_LIVE_REQUIRE_PROFILE_KEYS:-${RAZROOM_LIVE_REQUIRE_PROFILE_KEYS:-}}" \
