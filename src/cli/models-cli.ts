...
export function registerModelsCli(program: Command) {
  const models = program
    ...
    .option("--agent <id>", "Agent id to inspect (overrides RAZROOM_AGENT_DIR/PI_CODING_AGENT_DIR)")
    .addHelpText(
      "after",
      () =>
        `\n${theme.muted("Docs:")} ${formatDocsLink("/cli/models", "docs.razroom.ai/cli/models")}\n`,
    );
