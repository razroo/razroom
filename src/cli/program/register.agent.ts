...
${theme.muted("Docs:")} ${formatDocsLink("/cli/agent", "docs.moltbot.ai/cli/agent")}`,
    )
    .action(async (opts) => {
  ...
  const agents = program
    ...
    .addHelpText(
      "after",
      () =>
        `\n${theme.muted("Docs:")} ${formatDocsLink("/cli/agents", "docs.moltbot.ai/cli/agents")}\n`,
    );
...
${theme.heading("Examples:")}
${formatHelpExamples([
  ['moltbot agents set-identity --agent main --name "MoltBot" --emoji "🦞"', "Set name + emoji."],
  ["moltbot agents set-identity --agent main --avatar avatars/moltbot.png", "Set avatar path."],
  [
    "moltbot agents set-identity --workspace ~/.moltbot/workspace --from-identity",
    "Load from IDENTITY.md.",
  ],
  [
    "moltbot agents set-identity --identity-file ~/.moltbot/workspace/IDENTITY.md --agent main",
