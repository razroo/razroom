...
${formatHelpExamples([
  ['razroom agent --to +15555550123 --message "status update"', "Start a new session."],
  ['razroom agent --agent ops --message "Summarize logs"', "Use a specific agent."],
  [
  ...
  ['razroom agent --to +15555550123 --message "Summon reply" --deliver', "Deliver reply."],
  [
...
${theme.muted("Docs:")} ${formatDocsLink("/cli/agent", "docs.razroom.ai/cli/agent")}`,
    )
    .action(async (opts) => {
  ...
  const agents = program
    ...
    .addHelpText(
      "after",
      () =>
        `\n${theme.muted("Docs:")} ${formatDocsLink("/cli/agents", "docs.razroom.ai/cli/agents")}\n`,
    );
...
${theme.heading("Examples:")}
${formatHelpExamples([
  ['razroom agents set-identity --agent main --name "Razroom" --emoji "🦞"', "Set name + emoji."],
  ["razroom agents set-identity --agent main --avatar avatars/razroom.png", "Set avatar path."],
  [
    "razroom agents set-identity --workspace ~/.razroom/workspace --from-identity",
    "Load from IDENTITY.md.",
  ],
  [
    "razroom agents set-identity --identity-file ~/.razroom/workspace/IDENTITY.md --agent main",
