...
const githubCopilotLoginCommand = mock();
const modelsStatusCommand = mock().mockResolvedValue(undefined);
const noopAsync = mock(async () => undefined);

mock("../commands/models.js", () => ({
...
describe("models cli", () => {
  ...
  beforeAll(async () => {
    // Load once; mock above ensures command handlers are already mocked.
