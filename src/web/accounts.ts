...
export function listWhatsAppAuthDirs(cfg: RazroomConfig): string[] {
...
export function hasAnyWhatsAppAuth(cfg: RazroomConfig): boolean {
  return listWhatsAppAuthDirs(cfg).some((authDir) => hasWebCredsSync(authDir));
}

export function listWhatsAppAccountIds(cfg: RazroomConfig): string[] {
...
export function resolveDefaultWhatsAppAccountId(cfg: RazroomConfig): string {
...
export function resolveWhatsAppAuthDir(params: { cfg: RazroomConfig; accountId: string }): {
  authDir: string;
  isLegacy: boolean;
} {
...
export function listEnabledWhatsAppAccounts(cfg: RazroomConfig): ResolvedWhatsAppAccount[] {
