...
mock("../../auto-reply/reply.js", () => ({
  getReplyFromConfig: mock(async () => undefined),
}));

mock("../../channels/plugins/whatsapp-heartbeat.js", () => ({
...
mock("../../infra/heartbeat-visibility.js", () => ({
...
mock("./session-snapshot.js", () => ({
  getSessionSnapshot: () => state.snapshot,
}));

mock("../../infra/heartbeat-events.js", () => ({
...
mock("../outbound.js", () => ({
  sendMessageWhatsApp: mock(async () => ({ messageId: "m1" })),
}));
...
describe("runWebHeartbeatOnce", () => {
  ...
  let replyResolver: ReturnType<typeof mock>;
  ...
  beforeEach(() => {
    ...
    sender = mock(async () => ({ messageId: "m1" }));
    replyResolver = mock(async () => undefined);
  });
