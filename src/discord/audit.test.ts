...
mock("./send.js", () => ({
  fetchChannelPermissionsDiscord: mock(),
}));
...
describe("discord audit", () => {
  it("collects numeric channel ids and counts unresolved keys", async () => {
    ...
    } as unknown as import("../config/config.js").RazroomConfig;
    ...
    (fetchChannelPermissionsDiscord as unknown as ReturnType<typeof mock>).mockResolvedValueOnce({
      channelId: "111",
