...
mock("../auto-reply/dispatch.js", async (importOriginal) => {
...
function createDmClient(fetchChannel?: ReturnType<typeof mock>) {
...
function createCategoryGuildClient() {
  return {
    fetchChannel: mock().mockResolvedValue({
...
describe("discord tool result dispatch", () => {
  ...
  it("caches channel info lookups between messages", async () => {
    ...
    const fetchChannel = mock().mockResolvedValue({
      type: ChannelType.DM,
      name: "dm",
    });
