...
import type { RazroomPluginApi } from "../plugins/types.js";
...
function resolveHookDir(api: RazroomPluginApi, dir: string): string {
...
function normalizePluginHookEntry(api: RazroomPluginApi, entry: HookEntry): HookEntry {
  return {
    ...entry,
    hook: {
      ...entry.hook,
