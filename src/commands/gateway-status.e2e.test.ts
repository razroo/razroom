...
const resolveGatewayPort = mock(() => 18789);
const discoverGatewayBeacons = mock(async () => []);
const pickPrimaryTailnetIPv4 = mock(() => "100.64.0.10");
const sshStop = mock(async () => {});
const resolveSshConfig = mock(async () => null);
const startSshPortForward = mock(async () => ({
...
const probeGateway = mock(async ({ url }: { url: string }) => {
...
mock("../infra/ssh-tunnel.js", async (importOriginal) => {
