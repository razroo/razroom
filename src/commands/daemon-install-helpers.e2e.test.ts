...
const mocks = vi.hoisted(() => ({
  resolvePreferredNodePath: mock(),
  resolveGatewayProgramArguments: mock(),
  resolveSystemNodeInfo: mock(),
  renderSystemNodeWarning: mock(),
  buildServiceEnvironment: mock(),
}));

mock("../daemon/runtime-paths.js", () => ({
