...
export type { RazroomConfig } from "../config/config.js";
/** @deprecated Use RazroomConfig instead */
export type { RazroomConfig as ClawdbotConfig } from "../config/config.js";
