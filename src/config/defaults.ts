...
function resolveAnthropicDefaultAuthMode(cfg: RazroomConfig): AnthropicAuthDefaultsMode | null {
...
export function applyMessageDefaults(cfg: RazroomConfig): RazroomConfig {
...
export function applyTalkApiKey(config: RazroomConfig): RazroomConfig {
...
export function applyModelDefaults(cfg: RazroomConfig): RazroomConfig {
  let mutated = false;
  let nextCfg = cfg;
...
export function applyAgentDefaults(cfg: RazroomConfig): RazroomConfig {
...
export function applyLoggingDefaults(cfg: RazroomConfig): RazroomConfig {
...
export function applyContextPruningDefaults(cfg: RazroomConfig): RazroomConfig {
...
export function applyCompactionDefaults(cfg: RazroomConfig): RazroomConfig {
  const defaults = cfg.agents?.defaults;
  if (!defaults) {
    return cfg;
  }
