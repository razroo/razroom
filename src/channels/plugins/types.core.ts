...
export type ChannelAgentToolFactory = (params: { cfg?: RazroomConfig }) => ChannelAgentTool[];
...
export type ChannelAgentPromptAdapter = {
  messageToolHints?: (params: { cfg: RazroomConfig; accountId?: string | null }) => string[];
};
...
export type ChannelMessageActionAdapter = {
  listActions?: (params: { cfg: RazroomConfig }) => ChannelMessageActionName[];
  supportsAction?: (params: { action: ChannelMessageActionName }) => boolean;
  supportsButtons?: (params: { cfg: RazroomConfig }) => boolean;
  supportsCards?: (params: { cfg: RazroomConfig }) => boolean;
