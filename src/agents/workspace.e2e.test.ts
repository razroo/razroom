...
describe("resolveDefaultAgentWorkspaceDir", () => {
  it("uses MOLTBOT_HOME for default workspace resolution", () => {
    const dir = resolveDefaultAgentWorkspaceDir({
      MOLTBOT_HOME: "/srv/moltbot-home",
      HOME: "/home/other",
    } as NodeJS.ProcessEnv);

    expect(dir).toBe(path.join(path.resolve("/srv/moltbot-home"), ".moltbot", "workspace"));
  });
});

const WORKSPACE_STATE_PATH_SEGMENTS = [".moltbot", "workspace-state.json"] as const;
