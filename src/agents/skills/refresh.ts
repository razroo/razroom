...
function resolveWatchPaths(workspaceDir: string, config?: RazroomConfig): string[] {
  const paths: string[] = [];
...
function resolveWatchTargets(workspaceDir: string, config?: RazroomConfig): string[] {
...
export function ensureSkillsWatcher(params: { workspaceDir: string; config?: RazroomConfig }) {
