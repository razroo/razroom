...
const createChannelDiscord = mock(async () => ({
  id: "new-channel",
  name: "test",
  type: 0,
}));
const createThreadDiscord = mock(async () => ({}));
const deleteChannelDiscord = mock(async () => ({ ok: true, channelId: "C1" }));
const deleteMessageDiscord = mock(async () => ({}));
const editChannelDiscord = mock(async () => ({
  id: "C1",
  name: "edited",
}));
const editMessageDiscord = mock(async () => ({}));
const fetchMessageDiscord = mock(async () => ({}));
const fetchChannelPermissionsDiscord = mock(async () => ({}));
const fetchReactionsDiscord = mock(async () => ({}));
const listGuildChannelsDiscord = mock(async () => []);
const listPinsDiscord = mock(async () => ({}));
const listThreadsDiscord = mock(async () => ({}));
const moveChannelDiscord = mock(async () => ({ ok: true }));
const pinMessageDiscord = mock(async () => ({}));
const reactMessageDiscord = mock(async () => ({}));
const readMessagesDiscord = mock(async () => []);
const removeChannelPermissionDiscord = mock(async () => ({ ok: true }));
const removeOwnReactionsDiscord = mock(async () => ({ removed: ["👍"] }));
const removeReactionDiscord = mock(async () => ({}));
const searchMessagesDiscord = mock(async () => ({}));
const sendMessageDiscord = mock(async () => ({}));
const sendVoiceMessageDiscord = mock(async () => ({}));
const sendPollDiscord = mock(async () => ({}));
const sendStickerDiscord = mock(async () => ({}));
const setChannelPermissionDiscord = mock(async () => ({ ok: true }));
const unpinMessageDiscord = mock(async () => ({}));
const timeoutMemberDiscord = mock(async () => ({}));
const kickMemberDiscord = mock(async () => ({}));
const banMemberDiscord = mock(async () => ({}));
