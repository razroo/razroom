...
const deleteSlackMessage = mock(async () => ({}));
const editSlackMessage = mock(async () => ({}));
const getSlackMemberInfo = mock(async () => ({}));
const listSlackEmojis = mock(async () => ({}));
const listSlackPins = mock(async () => ({}));
const listSlackReactions = mock(async () => ({}));
const pinSlackMessage = mock(async () => ({}));
const reactSlackMessage = mock(async () => ({}));
const readSlackMessages = mock(async () => ({}));
const removeOwnSlackReactions = mock(async () => ["thumbsup"]);
const removeSlackReaction = mock(async () => ({}));
const sendSlackMessage = mock(async () => ({}));
const unpinSlackMessage = mock(async () => ({}));

mock("../../slack/actions.js", () => ({
