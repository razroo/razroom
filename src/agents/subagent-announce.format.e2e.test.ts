...
const agentSpy = mock(async () => ({ runId: "run-main", status: "ok" }));
const sessionsDeleteSpy = mock();
const readLatestAssistantReplyMock = mock(async () => "raw subagent reply");
const embeddedRunMock = {
  isEmbeddedPiRunActive: mock(() => false),
  isEmbeddedPiRunStreaming: mock(() => false),
  queueEmbeddedPiMessage: mock(() => false),
  waitForEmbeddedPiRunEnd: mock(async () => true),
};
const subagentRegistryMock = {
  isSubagentSessionRunActive: mock(() => true),
  countActiveDescendantRuns: mock(() => 0),
  resolveRequesterForChildSession: mock(() => null),
};
...
mock("../gateway/call.js", () => ({
  callGateway: mock(async (req: unknown) => {
...
mock("./tools/agent-step.js", () => ({
  readLatestAssistantReply: readLatestAssistantReplyMock,
}));

mock("../config/sessions.js", () => ({
  loadSessionStore: mock(() => sessionStore),
...
mock("./pi-embedded.js", () => embeddedRunMock);

mock("./subagent-registry.js", () => subagentRegistryMock);
