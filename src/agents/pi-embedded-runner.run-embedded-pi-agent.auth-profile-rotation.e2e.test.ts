...
const runEmbeddedAttemptMock = mock<Promise<EmbeddedRunAttemptResult>, [unknown]>();

mock("./pi-embedded-runner/run/attempt.js", () => ({
...
const makeConfig = (opts?: { fallbacks?: string[]; apiKey?: string }): RazroomConfig =>
  ({
    agents: {
      defaults: {
        model: {
