...
function resolveAvatarSource(cfg: RazroomConfig, agentId: string): string | null {
...
export function resolveAgentAvatar(cfg: RazroomConfig, agentId: string): AgentAvatarResolution {
