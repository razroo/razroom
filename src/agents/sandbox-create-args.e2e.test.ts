  ...
  it("includes hardening and resource flags", () => {
    ...
    expect(args).toEqual(
      expect.arrayContaining([
        ...
        "razroom.sandbox=1",
        "--label",
        "razroom.sessionKey=main",
        "--label",
        "razroom.createdAtMs=1700000000000",
        "--label",
        "razroom.sandboxBrowser=1",
        "--read-only",
        "--tmpfs",
        "/tmp",
        "--network",
