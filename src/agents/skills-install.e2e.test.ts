...
const scanDirectoryWithSummaryMock = mock();
const fetchWithSsrFGuardMock = mock();

mock("../process/exec.js", () => ({
  runCommandWithTimeout: (...args: unknown[]) => runCommandWithTimeoutMock(...args),
}));

mock("../infra/net/fetch-guard.js", () => ({
  fetchWithSsrFGuard: (...args: unknown[]) => fetchWithSsrFGuardMock(...args),
}));

mock("../security/skill-scanner.js", async (importOriginal) => {
