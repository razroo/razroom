...
const mocks = vi.hoisted(() => ({
  ...
  agentCommand: mock(),
  registerAgentRunContext: mock(),
  sessionsResetHandler: mock(),
...
mock("../../sessions/send-policy.js", () => ({
  resolveSendPolicy: () => "allow",
}));

mock("../../utils/delivery-context.js", async () => {
...
const makeContext = (): GatewayRequestContext =>
  ({
    dedupe: new Map(),
    addChatRun: mock(),
    logGateway: { info: mock(), error: mock() },
