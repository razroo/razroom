...
const mocks = vi.hoisted(() => ({
  ...
  listAgentEntries: mock(() => [] as Array<{ agentId: string }>),
  findAgentEntryIndex: mock(() => -1),
  applyAgentConfig: mock((_cfg: unknown, _opts: unknown) => ({})),
  pruneAgentConfig: mock(() => ({ config: {}, removedBindings: 0 })),
  writeConfigFile: mock(async () => {}),
  ensureAgentWorkspace: mock(async () => {}),
  resolveAgentDir: mock(() => "/agents/test-agent"),
  resolveAgentWorkspaceDir: mock(() => "/workspace/test-agent"),
  resolveSessionTranscriptsDirForAgent: mock(() => "/transcripts/test-agent"),
  listAgentsForGateway: mock(() => ({
    defaultId: "main",
    mainKey: "agent:main:main",
    scope: "global",
    agents: [],
  })),
  movePathToTrash: mock(async () => "/trashed"),
  fsAccess: mock(async () => {}),
  fsMkdir: mock(async () => undefined),
  fsAppendFile: mock(async () => {}),
  fsReadFile: mock(async () => ""),
  fsStat: mock(async () => null),
}));
...
mock("../../commands/agents.config.js", () => ({
...
mock("../../agents/workspace.js", async () => {
...
mock("../../config/sessions/paths.js", () => ({
  resolveSessionTranscriptsDirForAgent: mocks.resolveSessionTranscriptsDirForAgent,
}));

mock("../../browser/trash.js", () => ({
