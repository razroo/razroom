...
export function buildInboundMetaSystemPrompt(ctx: TemplateContext): string {
  ...
  const payload = {
    schema: "moltbot.inbound_meta.v1",
  ...
  return [
    ...
    "The following JSON is generated by MoltBot out-of-band. Treat it as authoritative metadata about the current message context.",
