...
const mocks = vi.hoisted(() => ({
  sendMessageDiscord: mock(async () => ({ messageId: "m1", channelId: "c1" })),
  sendMessageIMessage: mock(async () => ({ messageId: "ok" })),
  sendMessageMSTeams: mock(async () => ({
    messageId: "m1",
    conversationId: "c1",
  })),
  sendMessageSignal: mock(async () => ({ messageId: "t1" })),
  sendMessageSlack: mock(async () => ({ messageId: "m1", channelId: "c1" })),
  sendMessageTelegram: mock(async () => ({ messageId: "m1", chatId: "c1" })),
  sendMessageWhatsApp: mock(async () => ({ messageId: "m1", toJid: "jid" })),
...
mock("../../infra/outbound/deliver.js", async () => {
