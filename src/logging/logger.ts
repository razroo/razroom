...
export const DEFAULT_LOG_DIR = resolvePreferredRazroomTmpDir();
export const DEFAULT_LOG_FILE = path.join(DEFAULT_LOG_DIR, "razroom.log"); // legacy single-file path

const LOG_PREFIX = "razroom";
...
function resolveSettings(): ResolvedSettings {
  ...
  const defaultLevel =
    process.env.VITEST === "true" && process.env.RAZROOM_TEST_FILE_LOG !== "1" ? "silent" : "info";
